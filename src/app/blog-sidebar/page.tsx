        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className="shadow-three dark:bg-black mt-12 mb-10 rounded-xs bg-white p-6 lg:mt-0 dark:shadow-none">
              ...
              <div className="shadow-three dark:bg-black mb-10 rounded-xs bg-white dark:shadow-none">
